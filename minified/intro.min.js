...
f.step=m+1;"string"===typeof f.element&&(f.element=document.querySelector(f.element));b.push(f)}else{d=a.querySelectorAll("*[data-intro-text]");if(1>d.length)return!1;m=0;for(f=d.length;m<f;m++){var k=d[m];b.push({element:k,intro:k.getAttribute("data-intro-text"),step:parseInt(k.getAttribute("data-intro-step"),10),tooltipClass:k.getAttribute("data-intro-tooltipClass"),position:k.getAttribute("data-intro-position")||this._options.tooltipPosition})}}b.sort(function(a,b){return a.step-b.step});c._introItems=
b;z.call(c,a)&&(s.call(c),a.querySelector(".introjs-skipbutton"),a.querySelector(".introjs-nextbutton"),c._onKeyDown=function(b){if(27===b.keyCode&&!0==c._options.exitOnEsc)r.call(c,a),void 0!=c._introExitCallback&&c._introExitCallback.call(c);else if(37===b.keyCode)u.call(c);else if(39===b.keyCode||13===b.keyCode)s.call(c),b.preventDefault?b.preventDefault():b.returnValue=!1},c._onResize=function(a){t.call(c,document.querySelector(".introjs-helperLayer"))},window.addEventListener?(window.addEventListener("keydown",
c._onKeyDown,!0),window.addEventListener("resize",c._onResize,!0)):document.attachEvent&&(document.attachEvent("onkeydown",c._onKeyDown),document.attachEvent("onresize",c._onResize)));return!1}function s(){"undefined"===typeof this._currentStep?this._currentStep=0:++this._currentStep;if(this._introItems.length<=this._currentStep)"function"===typeof this._introCompleteCallback&&this._introCompleteCallback.call(this),r.call(this,this._targetElement);else{var a=this._introItems[this._currentStep];"undefined"!==
typeof this._introBeforeChangeCallback&&this._introBeforeChangeCallback.call(this,a.element);v.call(this,a)}}function u(){if(0===this._currentStep)return!1;var a=this._introItems[--this._currentStep];"undefined"!==typeof this._introBeforeChangeCallback&&this._introBeforeChangeCallback.call(this,a.element);v.call(this,a)}function r(a){var b=a.querySelector(".introjs-overlay");b.style.opacity=0;setTimeout(function(){b.parentNode&&b.parentNode.removeChild(b)},500);(a=a.querySelector(".introjs-helperLayer"))&&
...
function v(a){"undefined"!==typeof this._introChangeCallback&&this._introChangeCallback.call(this,a.element);var b=this,c=document.querySelector(".introjs-helperLayer");n(a.element);if(null!=c){var d=c.querySelector(".introjs-helperNumberLayer"),f=c.querySelector(".introjs-tooltiptext"),q=c.querySelector(".introjs-arrow"),k=c.querySelector(".introjs-tooltip"),e=c.querySelector(".introjs-skipbutton"),g=c.querySelector(".introjs-prevbutton"),l=c.querySelector(".introjs-nextbutton");k.style.opacity=
0;t.call(b,c);if((c=document.querySelectorAll(".introjs-fixParent"))&&0<c.length)for(var h=c.length-1;0<=h;h--)c[h].className=c[h].className.replace(/introjs-fixParent/g,"").replace(/^\s+|\s+$/g,"");c=document.querySelector(".introjs-showElement");c.className=c.className.replace(/introjs-[a-zA-Z]+/g,"").replace(/^\s+|\s+$/g,"");b._lastShowElementTimer&&clearTimeout(b._lastShowElementTimer);b._lastShowElementTimer=setTimeout(function(){null!=d&&(d.innerHTML=a.step);f.innerHTML=a.intro;w.call(b,a.element,
k,q);k.style.opacity=1},350)}else{e=document.createElement("div");c=document.createElement("div");h=document.createElement("div");e.className="introjs-helperLayer";t.call(b,e);this._targetElement.appendChild(e);c.className="introjs-arrow";h.innerHTML='<div class="introjs-tooltiptext">'+a.intro+'</div><div class="introjs-tooltipbuttons"></div>';this._options.showStepNumbers&&(g=document.createElement("span"),g.className="introjs-helperNumberLayer",g.innerHTML=a.step,e.appendChild(g));h.appendChild(c);
e.appendChild(h);l=document.createElement("a");l.onclick=function(){b._introItems.length-1!=b._currentStep&&s.call(b)};l.href="javascript:void(0);";l.innerHTML=this._options.nextLabel;g=document.createElement("a");g.onclick=function(){0!=b._currentStep&&u.call(b)};g.href="javascript:void(0);";g.innerHTML=this._options.prevLabel;e=document.createElement("a");e.className="introjs-button introjs-skipbutton";e.href="javascript:void(0);";e.innerHTML=this._options.skipLabel;e.onclick=function(){b._introItems.length-
1==b._currentStep&&"function"===typeof b._introCompleteCallback&&b._introCompleteCallback.call(b);b._introItems.length-1!=b._currentStep&&"function"===typeof b._introExitCallback&&b._introExitCallback.call(b);r.call(b,b._targetElement)};var p=h.querySelector(".introjs-tooltipbuttons");p.appendChild(e);1<this._introItems.length&&(p.appendChild(g),p.appendChild(l));w.call(b,a.element,h,c)}0==this._currentStep?(g.className="introjs-button introjs-prevbutton introjs-disabled",l.className="introjs-button introjs-nextbutton",
